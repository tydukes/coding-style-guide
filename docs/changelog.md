...
- AWS Cloud Provider Guide: Networking section covering VPC design, subnet layout (public/private/intra across 3 AZs), NAT Gateway (HA per-AZ), security groups, VPC endpoints (gateway and interface), Transit Gateway (hub-and-spoke with RAM sharing), Network ACLs, and VPC Flow Logs closes #396

## [v1.8.19] - 2026-02-22

## What's Changed
### New Features
- docs(aws): add IAM and security sections to aws.md (#395)
...
*This changelog was automatically generated on 2026-02-22 18:08:40 UTC*
