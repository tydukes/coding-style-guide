...
<!-- markdownlint-disable MD013 MD022 MD024 MD032 MD036 -->
...
## What's Changed
### New Features
* feat(ui): enable `navigation.path` breadcrumb trail below the header (#384)
...
## What's Changed
### Bug Fixes
* fix: exempt GitHub release tag URLs from link checker to prevent false positives from transient 502 errors

**Full Changelog**: <https://github.com/tydukes/coding-style-guide/compare/v1.8.9...v1.8.10>

[View Release](https://github.com/tydukes/coding-style-guide/releases/tag/v1.8.10)
...
*This changelog was automatically generated on 2026-02-22 17:19:19 UTC*
