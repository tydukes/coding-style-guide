...
## What's Changed
### 📚 Documentation
* docs(aws): scaffold aws.md — overview, account hierarchy, naming, and tagging by @tydukes in https://github.com/tydukes/coding-style-guide/pull/399
* docs(aws): add IAM and security sections to aws.md by @tydukes in https://github.com/tydukes/coding-style-guide/pull/400
### Other Changes
* docs(aws): add networking section to AWS Cloud Provider Guide by @tydukes in https://github.com/tydukes/coding-style-guide/pull/401
* docs(aws): add compute and data services sections by @tydukes in https://github.com/tydukes/coding-style-guide/pull/402
* docs(aws): add observability, CI/CD, state, cost, Terragrunt, and nav by @tydukes in https://github.com/tydukes/coding-style-guide/pull/403


**Full Changelog**: https://github.com/tydukes/coding-style-guide/compare/v1.8.17...v1.8.23

[View Release](https://github.com/tydukes/coding-style-guide/releases/tag/v1.8.23)
